...
path1 = "/home/rick/SRSS/data/new/dynamic/1+1+1/modify/all_distance"
path2 = "/home/rick/SRSS/data/new/dynamic/2+1/modify/all_distance"
path3 = "/home/rick/SRSS/data/new/dynamic/1+2/modify/all_distance"
...
energy_sum_sum_mean1 = [sum(x) for x in it.zip_longest(*energy_sum_mean1, fillvalue = 0)]
...
energy_sum_sum_mean2 = [sum(x) for x in it.zip_longest(*energy_sum_mean2, fillvalue = 0)]
...
energy_sum_sum_mean3 = [sum(x) for x in it.zip_longest(*energy_sum_mean3, fillvalue = 0)]
...
plt.legend(['1+1+1_System_Distance','2+1_System_Distance','1+2_System_Distance'])
plt.show()
