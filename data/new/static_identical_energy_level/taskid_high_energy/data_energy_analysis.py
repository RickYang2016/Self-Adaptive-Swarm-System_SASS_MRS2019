...
path = "/home/rick/SRSS/data/new/static_identical_energy_level/taskid_high_energy/all_energy_level"
files = os.listdir(path)
energy_sum_sum,energy_sum_mean,total_energy,total_energy1,total_energy2 = [],[],[],[],[]

w = open('/home/rick/SRSS/data/new/static_identical_energy_level/taskid_high_energy/taskid_high_energy_energy.txt', 'a')
