...
image_robot = [Image.open("/home/rick/Documents/research/SRSS/thumbnail_ugv3_60.png"), Image.open("/home/rick/Documents/research/SRSS/thumbnail_ugv3_60.png")]
photo_robot = [ImageTk.PhotoImage(image, master=canvas, width=40, height=40) for image in image_robot]

image_task = Image.open("/home/rick/Documents/research/SRSS/thumbnail_goal point.png")
...
# 1+2
# task = [(5, [325, 475]), (60, [1200, 700]), (60, [1075, 175])]

# 2+1
# task = [(5, [325, 475]), (5, [1200, 700]), (60, [1075, 175])]
...
# # 2 tasks
# task = [(5, [325, 475]), (5, [1075, 175])]

# # 3 tasks
# task = [(5, [325, 475]), (5, [1200, 700]), (5, [1075, 175])]

# 4 tasks
task = [(5, [325, 475]), (5, [1200, 700]), (5, [1075, 175]), (5, [800, 600])]
